//This is heavily heavily adapted from https://github.com/espressif/arduino-esp32/blob/master/libraries/BLE/examples/Client/Client.ino
...
bool connectToServer() {
  ...
  if (pRemoteCharacteristic->canRead()) {
    ...
    //TODO: can add servo stuff here I believe
  }
...
void loop() {
  ...
  if (doConnect == true) {
    if (connectToServer()) {
      ...
      //Originally I would have put something like ESP.restart() but I think with callbacks it'd mess up
    }
    doConnect = false;
  }
